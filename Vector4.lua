	...
	static
	{
		...
		FromQ2	= function( q1 )
			...
			if test < -0.4995 * unit then -- singularity at south pole
				...
				return Vector4.NormalizeAngles( v * math.Rad2Deg );
			end
			
			local q = new. Vector4( q1.W, q1.Z, q1.X, q1.Y );
		...
		NormalizeAngles	= function( vecAngles )
			vecAngles.X = Vector4.NormalizeAngle( vecAngles.X );
			vecAngles.Y = Vector4.NormalizeAngle( vecAngles.Y );
			vecAngles.Z = Vector4.NormalizeAngle( vecAngles.Z );
